...
- `/api/latest/[country]` for latest specific country case summary
- `/api/[mm-dd-yy]/global` for global case summary at specific date
- `/api/[mm-dd-yy]/[country]` for specific country case summary at specific date
